#!/usr/bin/env python3
"""Extract frames and captions from YouTube videos."""
...
def extract_captions(video_id, output_dir):
    ...
    # Try to get captions via yt-dlp
    cmd = [
...
def main():
    if len(sys.argv) < 2:
        print("Usage: watch-video.py <video_id_or_url>")
        sys.exit(1)
    ...
    # Extract frames
    frames = extract_frames(video_id, output_dir)
