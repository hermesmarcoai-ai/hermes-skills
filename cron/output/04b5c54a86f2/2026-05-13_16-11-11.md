...
| Category | Count |
|---|---|
| Tasks promoted triage→ready | 0 |
| Tasks needing triage | 0 |
| Ready tasks dispatched | 0 |
| Ready tasks pending (no agent) | 0 |

**Board status:** Empty — no tasks in triage or ready states.
